...
import { Root as CheckboxRoot, Indicator as CheckboxIndicatorPrimitive, createCheckboxScope } from '@radix-ui/react-checkbox';
...
const CheckboxPrimitive = { Root: CheckboxRoot, createCheckboxScope, Indicator: CheckboxIndicatorPrimitive };
/* -------------------------------------------------------------------------------------------------
 * CheckboxGroup
 * -----------------------------------------------------------------------------------------------*/
...
type CheckboxGroupIndicatorElement = React.ElementRef<typeof CheckboxIndicatorPrimitive>;
type CheckboxIndicatorProps = React.ComponentPropsWithoutRef<typeof CheckboxIndicatorPrimitive>;
...
>((props: ScopedProps<CheckboxGroupIndicatorProps>, forwardedRef) => {
  ...
  const checkboxScope = useCheckboxScope(__scopeCheckboxGroup);
  return <CheckboxIndicatorPrimitive {...checkboxScope} {...indicatorProps} ref={forwardedRef} />;
});
